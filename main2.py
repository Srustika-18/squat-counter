...
if __name__ == '__main__':
    ...
    while True:
        ...
        if args.leg == 'right':
            try:
                center_8 = (int(humans[0].body_parts[8].x * w),
                            int(humans[0].body_parts[8].y * h))  # right hip
                center_9 = (int(humans[0].body_parts[9].x * w),
                            int(humans[0].body_parts[9].y * h))  # right knee
                center_10 = (int(humans[0].body_parts[10].x * w),
                             int(humans[0].body_parts[10].y * h))  # right ankle

                squat_right_angle = angle_between_points(
                    center_8, center_9, center_10)
